...
console.log("hallo");
const h2Category = document.querySelector(".category-header");
if (h2Category) {
...
const burgerNav = document.querySelector(".container-burger-nav");
...
function addToCart(item) {
    ...
    if (indexInCart === -1) {
        ...
        let newPrise = Math.round((item.price - (item.price * discont) / 100) * 100) / 100;
...
function printCart() {
    ...
    const stripe = Stripe("pk_test_51RfGezH8oitdDHtZQRBnLCMTjCJIOFS2eD2OBg7l1F4OGmwR7lCcMcrPTKzV1EVLh06tpkouNQBejKDr74cyV2SY00O3rH3GGb");
...
const printCards = (cards) => {
    ...
    cards.forEach((item) => {
        ...
        let discont = mainDiskont < item.discont ? item.discont : mainDiskont;
        let newPrise = item.price - (item.price * discont) / 100;
        let newPriceRound = newPrise.toFixed(2);
        ...
        //=========== onClick img ===============================================
        //=======================================================================
        const img = cardHtml.querySelector(".card-img");
        // =========create DESCRIPTION=====================
        ...
        img.onclick = () => {
            ...
            //================ Bay Modal ========================================
            const bayBtn = modalCard.querySelector(".bay");
            bayBtn.onclick = () => {
                addToCart(item);
                setCart(cart);
        ...
        //=======================================================================
        //======= BAY NOW =======================================================
        const bayBtn = cardHtml.querySelector(".bay");
        bayBtn.onclick = () => {
            addToCart(item);
            setCart(cart);
            console.log(cart);
...
//==========================================================================
//============== Cart ======================================================
let cartBnt = document.querySelector(".basket");
printCartTotal(cauntTotal());
//==============VISIBL======================================================
...
document.addEventListener("DOMContentLoaded", () => {
    cart = getCart();
    printCartTotal(cauntTotal());
    cartBnt = document.querySelector(".basket");
});
//======================================================================
//======================================================================
const documentContainer = document.getElementById("shop");
    ...
    fetch("./cards.json")
        ...
        categoryList.forEach((btn) => {
            btn.onclick = () => {
                ...
                let category = btn.getAttribute("data-type");
